...
/** Receitas: cadastro manual, com edição e marcação de status (gravação pelo servidor). */
export default function ReceitasPage() {
  ...
  async function load(p = periodo, d = de, a = ate) {
    let tq = supabase.from("transactions")
      .select("id, transaction_date, description_clean, amount, status, category_id, account_id, is_recurring, notes, categories(name, color), accounts(name)")
      .eq("type", "income")
